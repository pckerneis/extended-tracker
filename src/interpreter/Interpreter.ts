...
// }
//
// export type SequenceLike = ParametrizedSequence | SequenceRef | SequenceDeclaration | SequenceOperation | TernaryInstruction;
//
// export type Assignable = SequenceLike | Primitive;
//
// interface Primitive {
